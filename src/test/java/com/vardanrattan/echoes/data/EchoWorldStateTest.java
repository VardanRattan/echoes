...
//     private final ResourceKey<Level> overworld = ResourceKey.create(Registries.DIMENSION, Identifier.of("minecraft", "overworld"));
...
//                 UUID.getRandom()UUID(), UUID.getRandom()UUID(), "OldTimer",
